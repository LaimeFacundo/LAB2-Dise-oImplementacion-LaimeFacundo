 ...
 * @author yofac
 */
public class FrameCuadrosCombinados extends javax.swing.JFrame {

    /**
     * Creates new form FrameCuadrosCombinados
     */
    public FrameCuadrosCombinados() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameCuadrosCombinados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameCuadrosCombinados().setVisible(true);
            }
        });
    }

 ...
 */
package GuiaBotoOpcion;

/**
 *
 * @author yofac
 */
public class FrameBotonesDeOpcion extends javax.swing.JFrame {

    /**
     * Creates new form FrameBotonesDeOpcion
     */
    public FrameBotonesDeOpcion() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Colores", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(0, 102, 102))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameBotonesDeOpcion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameBotonesDeOpcion().setVisible(true);
            }
        });
    }
